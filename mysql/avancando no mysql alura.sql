...
SELECT NOME, DATA_DE_NASCIMENTO, TIMESTAMPDIFF(YEAR, DATA_DE_NASCIMENTO, CURDATE()) AS IDADE FROM TABELA_DE_CLIENTES;

SELECT (23+((25-2)/2)*45) AS RESULTADO;

SELECT CEILING(12.33333333232232232) AS RESULTADO;

SELECT ROUND(12.7222222222222222) AS RESULTADO;

SELECT FLOOR(12.3232587) AS RESULTADO;

SELECT (RAND()+ 1) AS RESULTADO;
...
/* CONSULTA COM VENDAS DE CLEINTES POR MÊS */
...
SELECT X.CPF, X.NOME, X.MES_ANO, X.QUANTIDADE_VENDAS, X.QUANTIDADE_LIMITE,
CASE WHEN (X.QUANTIDADE_LIMITE - X.QUANTIDADE_VENDAS) < 0 THEN 'INVÁLIDA'
ELSE 'VÁLIDA' END AS STATUS_VENDA, ROUND((1 - (X.QUANTIDADE_LIMITE/X.QUANTIDADE_VENDAS)) * 100, 2) AS PERCENTUAL
